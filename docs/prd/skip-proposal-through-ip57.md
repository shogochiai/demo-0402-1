# Skip Proposal: exclude IP-1..57

## Goal

Allow Colony to ignore all finalized IP proposals up to and including `IP-57`,
...
- Colony treats `IP-1` through `IP-57` as excluded from execution.
